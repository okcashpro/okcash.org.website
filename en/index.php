            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="http://cn.okcash.co">CN</a></li><li><a href="http://es.okcash.co">ES</a></li><li><a href="http://pt.okcash.co">PT</a></li>
                        </ul>
                </ul>
            </div>
        </div>
...
<div class="clear">&nbsp;</div>
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2014-2016 OKCash Project. Released under the <a target="_blank" href="https://github.com/okcashpro/okcash.co.website/blob/master/LICENSE" title="MIT license">MIT license</a>.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
